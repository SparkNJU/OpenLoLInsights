      ...
      <div v-loading="loading" class="space-y-6 max-w-7xl mx-auto">
        ...
        <template v-else-if="matchData">
            ...
            <div class="relative flex items-center justify-around z-10">
              ...
              <div class="text-center w-1/3">
                <div class="text-3xl font-bold text-gray-900 mb-1 flex items-center justify-center gap-2">
                  ...
                  <el-icon v-if="matchData.winnerId === matchData.team1.id" class="text-yellow-500">
                    <Trophy />
                  </el-icon>
                </div>
              ...
              <div class="flex flex-col items-center">
                ...
                <div class="mt-2 px-3 py-1 bg-gray-100 text-gray-500 text-xs rounded-full">BO{{ matchData.games.length >
                  3 ? 5 : 3 }}</div>
              </div>
              ...
              <div class="text-center w-1/3">
                <div class="text-3xl font-bold text-gray-900 mb-1 flex items-center justify-center gap-2">
                  ...
                  <el-icon v-if="matchData.winnerId === matchData.team2.id" class="text-yellow-500">
                    <Trophy />
                  </el-icon>
                </div>
          ...
          <el-tabs v-model="activeGameTab" type="border-card" class="rounded-xl shadow-sm border-gray-100 custom-tabs">
            <el-tab-pane v-for="game in matchData.games" :key="game.gameNumber" :label="`Game ${game.gameNumber}`"
              ...
              <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
                <div class="flex items-center gap-4">
                  ...
                  <span class="px-2 py-0.5 rounded text-xs"
                    :class="game.winnerId === game.blueTeamId ? 'bg-blue-100 text-blue-700' : 'bg-red-100 text-red-700'">
              ...
              <div v-if="currentGameTeamStats" class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div class="bg-blue-50 rounded-lg p-4 text-center border border-blue-100">
                  ...
                  <div class="flex justify-center text-sm">
                    <div>
                      <div class="font-bold text-gray-700">19</div>
                ...
                <div class="bg-red-50 rounded-lg p-4 text-center border border-red-100">
                  ...
                  <div class="flex justify-center text-sm">
                    <div>
                      <div class="font-bold text-gray-700">16</div>
                      <div class="text-gray-400 text-xs">Total Kills</div>
                    </div>
                  </div>
                </div>
              ...
              <div v-if="currentGameTeamStats" class="space-y-8 pb-4">
                ...
                <div>
                  ...
                  <el-table :data="blueTeamFakePlayers" style="width: 100%" size="small" stripe>
                    ...
                    <el-table-column label="Player" min-width="120">
                      <template #default="{ row }">
                        <div class="font-bold text-gray-800 flex items-center gap-1">
                          {{ row.playerName }}
                          <el-icon v-if="row.isMvp" class="text-yellow-500">
                            <Medal />
                          </el-icon>
                        </div>
                      </template>
                ...
                <div>
                  ...
                  <el-table :data="redTeamFakePlayers" style="width: 100%" size="small" stripe>
                    <el-table-column prop="position" label="Pos" width="60" />
                    <el-table-column label="Player" min-width="120">
                      <template #default="{ row }">
                        <div class="font-bold text-gray-800 flex items-center gap-1">
...
// --- 静态假数据 ---
const blueTeamFakePlayers = computed(() => {
  return [
    { position: 'TOP', playerName: 'Zeus', championName: '杰斯', kills: 3, deaths: 1, assists: 5, isMvp: false },
    { position: 'JG', playerName: 'Oner', championName: '盲僧', kills: 2, deaths: 2, assists: 8, isMvp: false },
    { position: 'MID', playerName: 'Faker', championName: '阿狸', kills: 5, deaths: 1, assists: 6, isMvp: true },
    { position: 'ADC', playerName: 'Gumayusi', championName: '厄斐琉斯', kills: 8, deaths: 2, assists: 4, isMvp: false },
    { position: 'SUP', playerName: 'Keria', championName: '洛', kills: 1, deaths: 3, assists: 12, isMvp: false }
  ]
})

const redTeamFakePlayers = computed(() => {
  return [
    { position: 'TOP', playerName: '369', championName: '奎桑提', kills: 2, deaths: 4, assists: 3, isMvp: false },
    { position: 'JG', playerName: 'Tian', championName: '佛耶戈', kills: 4, deaths: 3, assists: 5, isMvp: false },
    { position: 'MID', playerName: 'Creme', championName: '阿卡丽', kills: 6, deaths: 3, assists: 4, isMvp: false },
    { position: 'ADC', playerName: 'JackeyLove', championName: '卡莎', kills: 7, deaths: 4, assists: 2, isMvp: false },
    { position: 'SUP', playerName: 'Meiko', championName: '塔姆', kills: 0, deaths: 5, assists: 9, isMvp: false }
  ]
})
